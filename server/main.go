...
func initMovies() {
	movie1 := &pb.MovieInfo{
		Id: "1", Isbn: "05233655", Title: "The Iron Man", Director: &pb.Director{
			firstname: "Akashkumar", lastname: "Jeyaraman",
		}}
	movie2 := &pb.MovieInfo{
		Id: "2", Isbn: "05233665", Title: "The Iron Man2", Director: &pb.Director{
			firstname: "Magi", lastname: "AK",
		}}
...
//we are streaming so we don't need to add context
...
// func (s *movieServer) GetMovies(ctx context.Context, in *pb.Empty) (*pb.MovieInfo, error){
